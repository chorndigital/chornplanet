...
export const MetaHumanDailyFlowMiddayZH_CN: Metadata = {
    title: "正午节律——密度与协同 | 智慧城市",
    description:
        "正午揭示密度是令人混乱，还是被良好协同。智慧城市能够支持人群、物流与出行系统的重叠运行，而不制造压力。",

    alternates: {
        canonical: "/zh-cn/smart-city/human-daily-flow-midday",
        languages: {
    ...
    openGraph: {
        title: "正午节律——密度与协同 | 智慧城市",
        description:
            "在强度最高的时段，物流、行人、车辆与共享空间必须悄然协同。当系统彼此对齐时，密度带来的感受是平静，而不是混乱。",
        url: "/zh-cn/smart-city/human-daily-flow-midday",
        type: "website",
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "繁忙的泰国正午城市街道，行人、踏板车、自行车、配送机器人与自动驾驶电动穿梭车共同移动",
            },
        ],
    },
