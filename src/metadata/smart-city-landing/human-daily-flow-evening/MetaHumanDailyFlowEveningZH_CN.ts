...
export const MetaHumanDailyFlowEveningZH_CN: Metadata = {
    title: "夜晚节律——放慢与恢复 | 智慧城市",
    description:
        "夜晚不是关于速度，而是关于恢复。智慧城市体现在街道是否足够安全，让人们在日落之后依然可以放松、散步、相聚并停留。",

    alternates: {
        canonical: "/zh-cn/smart-city/human-daily-flow-evening",
        languages: {
    ...
    openGraph: {
        title: "夜晚节律——放慢与恢复 | 智慧城市",
        description:
            "夜晚揭示城市是否在白天之外依然提供舒适。照明、步行友好性与可预测的出行方式，决定了日落之后公共生活是否仍然平静而友好。",
        url: "/zh-cn/smart-city/human-daily-flow-evening",
        type: "website",
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "傍晚的泰国城市街道，温暖灯光下行人和安静的踏板车营造出安全的社交氛围",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "夜晚节律——放慢与恢复 | 智慧城市",
        description:
            "当人们放慢脚步，并在日落后仍感到足够安全停留在户外时，城市的品质便清晰可见。",
        images: [
