...
export const MetaHumanDailyFlowEveningJA: Metadata = {
    title: "夕方の流れ — 減速と回復 | スマートシティ",
    description:
        "夕方はスピードのためではなく、回復のための時間です。スマートシティは、日没後も人々が安心してリラックスし、歩き、出会い、街にとどまれるかどうかに表れます。",

    alternates: {
        canonical: "/ja/smart-city/human-daily-flow-evening",
        languages: {
    ...
    openGraph: {
        title: "夕方の流れ — 減速と回復 | スマートシティ",
        description:
            "夕方は、都市が日中以外の時間にも快適さを支えられるかを映し出します。照明、歩きやすさ、予測可能な移動が、日没後も公共の暮らしが落ち着いて心地よく続くかを左右します。",
        url: "/ja/smart-city/human-daily-flow-evening",
        type: "website",
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "暖かな灯りのあるタイの街の夕暮れ、歩行者と落ち着いたスクーターが行き交い、社交的な生活に安全な雰囲気がある",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "夕方の流れ — 減速と回復 | スマートシティ",
        description:
            "人々がペースを落とし、日没後も外にいられるほど安全だと感じるとき、都市の質が見えてきます。",
        images: [
