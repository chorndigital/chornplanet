...
export const MetaHumanDailyFlowEveningKO: Metadata = {
    title: "저녁의 흐름 — 속도를 늦추고 회복하다 | 스마트 시티",
    description:
        "저녁은 속도를 위한 시간이 아니라 회복을 위한 시간입니다. 스마트 시티는 해가 진 후에도 사람들이 편안히 걷고, 만나고, 머물 수 있을 만큼 거리가 안전하게 느껴지는지에서 드러납니다.",

    alternates: {
        canonical: "/ko/smart-city/human-daily-flow-evening",
        languages: {
    ...
    openGraph: {
        title: "저녁의 흐름 — 속도를 늦추고 회복하다 | 스마트 시티",
        description:
            "저녁은 도시가 낮 시간을 넘어 편안함을 지원하는지 보여줍니다. 조명, 보행성, 예측 가능한 이동 체계가 해가 진 뒤에도 공공의 삶이 차분하고 환영받는 분위기를 유지하는지를 결정합니다.",
        url: "/ko/smart-city/human-daily-flow-evening",
        type: "website",
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "따뜻한 조명 아래 보행자와 차분한 스쿠터가 있는 태국 도시의 이른 저녁 거리",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "저녁의 흐름 — 속도를 늦추고 회복하다 | 스마트 시티",
        description:
            "사람들이 속도를 늦추고 해가 진 후에도 밖에 머물 만큼 안전하다고 느낄 때, 도시의 품질이 드러납니다.",
        images: [
