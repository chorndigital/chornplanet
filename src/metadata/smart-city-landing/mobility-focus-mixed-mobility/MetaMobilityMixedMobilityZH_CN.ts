// src/metadata/smart-city-landing/mobility-focus-mixed-mobility/MetaMobilityMixedMobilityZH_CN.ts

import {Metadata} from "next";

export const MetaMobilityMixedMobilityZH_CN: Metadata = {
    title: "Mixed Mobility 的共存 | Smart City Mobility",
    description:
        "现代街道不再围绕单一出行方式进行设计。Mixed mobility 让行人、滑板车、自行车、机器人以及自动驾驶车辆能够自然且安全地共存。",
    ...
    openGraph: {
        title: "Mixed Mobility 的共存 | Smart City Mobility",
        description:
            "智慧城市并非以严格分隔来定义，而是通过让不同出行方式的共存变得清晰、平静且安全来实现。",
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "泰国街道场景，行人、滑板车、自行车骑行者与自动驾驶接驳车自然共存",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "Mixed Mobility 的共存 | Smart City Mobility",
        description:
            "Mixed mobility 体现了向共享街道转变的趋势，让多样化的出行方式能够舒适地共存。",
        images: [
