// src/metadata/smart-city-landing/mobility-focus-predictable-movement/MetaMobilityPredictableMovementKO.ts

import {Metadata} from "next";

export const MetaMobilityPredictableMovementKO: Metadata = {
    title: "공유 도로에서의 예측 가능한 움직임 | Smart City Mobility",
    description:
        "모빌리티는 신뢰로 경험됩니다. 횡단 구간이 명확하고 차량이 자연스럽게 감속할 때, 예측 가능한 움직임은 엄격한 통제 없이도 일상의 안전을 만들어냅니다.",
    ...
    openGraph: {
        title: "공유 도로에서의 예측 가능한 움직임 | Smart City Mobility",
        description:
            "예측 가능성은 불확실성을 줄입니다. 명확한 횡단 구역, 읽기 쉬운 신호, 동기화된 흐름은 보행자, 자전거 이용자, 차량이 차분하게 공존하도록 돕습니다.",
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "태국의 공유 도로에서 예측 가능한 흐름 속에 차분히 이동하는 보행자와 자전거 이용자, 배경에는 자율주행 셔틀",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "공유 도로에서의 예측 가능한 움직임 | Smart City Mobility",
        description:
            "예측 가능한 움직임은 신뢰를 구축하고 스트레스를 줄이며, 공유 도로에서의 안전한 공존을 가능하게 합니다.",
        images: [
