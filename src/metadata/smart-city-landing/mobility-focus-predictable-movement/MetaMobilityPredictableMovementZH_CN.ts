// src/metadata/smart-city-landing/mobility-focus-predictable-movement/MetaMobilityPredictableMovementZH_CN.ts

import {Metadata} from "next";

export const MetaMobilityPredictableMovementZH_CN: Metadata = {
    title: "共享街道中的可预测流动 | Smart City Mobility",
    description:
        "出行被体验为一种信心。当过街区域清晰、车辆自然减速时，可预测的流动无需严格管控也能创造日常安全。",
    ...
    openGraph: {
        title: "共享街道中的可预测流动 | Smart City Mobility",
        description:
            "可预测性减少不确定性。清晰的过街区域、易读的信号以及同步的交通流，让行人、骑行者与车辆能够平静共存。",
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "在可预测流动的共享街道上，泰国行人与骑行者平静移动，背景为自动驾驶接驳车",
            },
        ],
    },
