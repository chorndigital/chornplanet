// src/metadata/smart-city-landing/mobility-focus-predictable-movement/MetaMobilityPredictableMovementJA.ts

import {Metadata} from "next";

export const MetaMobilityPredictableMovementJA: Metadata = {
    title: "共有道路における予測可能な動き | Smart City Mobility",
    description:
        "モビリティは信頼として体験されます。横断が明確で、車両が自然に減速する環境では、予測可能な動きが厳格な管理なしに日常の安全を生み出します。",
    ...
    openGraph: {
        title: "共有道路における予測可能な動き | Smart City Mobility",
        description:
            "予測可能性は不確実性を減らします。明確な横断歩道、読み取りやすい信号、そして同期した交通の流れにより、歩行者、自転車利用者、車両が穏やかに共存できます。",
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "タイの共有道路で予測可能な流れの中を穏やかに移動する歩行者と自転車利用者、背景には自動運転シャトル",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "共有道路における予測可能な動き | Smart City Mobility",
        description:
            "予測可能な動きは信頼を築き、ストレスを軽減し、共有道路での安全な共存を可能にします。",
        images: [
