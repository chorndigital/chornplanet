...
export const MetaHumanDailyFlowMorningZH_CN: Metadata = {
    title: "清晨节律——一天的开始 | 智慧城市",
    description:
        "清晨揭示城市是否支持日常节律。清晨的过街、通勤与第一波流动，展现出交通系统是否能够减少摩擦并建立信任。",

    alternates: {
        canonical: "/zh-cn/smart-city/human-daily-flow-morning",
        languages: {
    ...
    openGraph: {
        title: "清晨节律——一天的开始 | 智慧城市",
        description:
            "清晨是城市系统的早期压力测试。一个可靠的城市由“可读性”定义——行人、踏板车、自行车与车辆能够在冲突最小的情况下平静协同。",
        url: "/zh-cn/smart-city/human-daily-flow-morning",
        type: "website",
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "清晨的泰国城市街道，通勤者步行，踏板车平稳行驶，背景中有一辆安静的自动驾驶穿梭车",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "清晨节律——一天的开始 | 智慧城市",
        description:
            "清晨的流动揭示城市是否具备可读性、可预测性，并已为日常生活做好准备。",
        images: [
