...
export const MetaHumanDailyFlowMorningJA: Metadata = {
    title: "朝の流れ — 一日の始まり | スマートシティ",
    description:
        "朝は、都市が日々のリズムを支えているかを映し出します。早朝の横断、通勤、そして一日の最初の動きが、モビリティシステムが摩擦を減らし信頼を築けているかを示します。",

    alternates: {
        canonical: "/ja/smart-city/human-daily-flow-morning",
        languages: {
    ...
    openGraph: {
        title: "朝の流れ — 一日の始まり | スマートシティ",
        description:
            "朝は都市システムにとって早い段階のストレステストです。信頼できる都市は「読み取れること」によって定義されます。歩行者、スクーター、自転車、車両が最小限の衝突で落ち着いて協調できることです。",
        url: "/ja/smart-city/human-daily-flow-morning",
        type: "website",
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "早朝のタイの都市の通りで、通勤者が歩き、スクーターが落ち着いて動き、背景には静かな自律走行シャトルがある",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "朝の流れ — 一日の始まり | スマートシティ",
        description:
            "朝の流れは、都市が読み取れ、予測でき、日常に備えているかを示します。",
        images: [
