// src/metadata/smart-city-landing/urban-signals-logistics-integration/MetaUrbanSignalsLogisticsIntegrationZH_CN.ts

import {Metadata} from "next";

export const MetaUrbanSignalsLogisticsIntegrationZH_CN: Metadata = {
    title: "融入日常生活的城市物流 | Urban Signals",
    description:
        "高度整合的物流系统往往几乎不被察觉。当配送机器人和小型电动车在不打扰街道生活的情况下运行时，这体现了系统的成熟与城市节奏的从容。",
    ...
    openGraph: {
        title: "融入日常生活的城市物流 | Urban Signals",
        description:
            "智慧城市的定义不在于配送系统是否显眼，而在于物流是否能够在不影响人的舒适感和街道生活的前提下，自然融入日常节奏。",
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "配送机器人和小型电动车物流自然融入日常生活的泰国城市街道",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "融入日常生活的城市物流 | Urban Signals",
        description:
            "当配送系统融入日常生活而非主导街道时，物流便成为城市系统成熟与从容的信号。",
        images: [
