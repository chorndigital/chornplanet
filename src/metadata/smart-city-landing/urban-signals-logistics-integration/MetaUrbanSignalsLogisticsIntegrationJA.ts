// src/metadata/smart-city-landing/urban-signals-logistics-integration/MetaUrbanSignalsLogisticsIntegrationJA.ts

import {Metadata} from "next";

export const MetaUrbanSignalsLogisticsIntegrationJA: Metadata = {
    title: "日常生活に溶け込む物流 | Urban Signals",
    description:
        "適切に統合された物流は、ほとんど気づかれないことさえあります。配送ロボットや小型EVが街の営みを妨げることなく稼働するとき、それはシステムの成熟と穏やかな都市のリズムを示しています。",
    ...
    openGraph: {
        title: "日常生活に溶け込む物流 | Urban Signals",
        description:
            "スマートシティは、配送システムの目立ちやすさではなく、物流が人の快適さや街の営みを損なうことなく日常のリズムに自然に溶け込んでいるかどうかで定義されます。",
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "配送ロボットと小型EV物流が日常生活に溶け込むタイの都市風景",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "日常生活に溶け込む物流 | Urban Signals",
        description:
            "配送システムが街を支配するのではなく日常に溶け込むとき、物流は穏やかで成熟した都市システムのサインとなります。",
        images: [
