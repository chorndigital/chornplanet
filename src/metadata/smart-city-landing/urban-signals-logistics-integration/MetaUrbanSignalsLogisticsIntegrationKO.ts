// src/metadata/smart-city-landing/urban-signals-logistics-integration/MetaUrbanSignalsLogisticsIntegrationKO.ts

import {Metadata} from "next";

export const MetaUrbanSignalsLogisticsIntegrationKO: Metadata = {
    title: "일상에 자연스럽게 녹아드는 물류 | Urban Signals",
    description:
        "잘 통합된 물류 시스템은 거의 눈에 띄지 않습니다. 배송 로봇과 소형 전기차가 거리의 일상을 방해하지 않고 운영될 때, 이는 시스템의 성숙도와 도시의 안정된 리듬을 보여줍니다.",
    ...
    openGraph: {
        title: "일상에 자연스럽게 녹아드는 물류 | Urban Signals",
        description:
            "스마트 시티는 배송 시스템이 얼마나 눈에 띄는지가 아니라, 물류가 사람의 편안함과 거리의 일상을 해치지 않고 자연스럽게 일상의 흐름에 스며드는지로 정의됩니다.",
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "배송 로봇과 소형 전기차 물류가 일상에 자연스럽게 녹아든 태국 도시 거리",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "일상에 자연스럽게 녹아드는 물류 | Urban Signals",
        description:
            "배송 시스템이 도시를 지배하지 않고 일상에 조화롭게 스며들 때, 물류는 안정되고 성숙한 도시 시스템의 신호가 됩니다.",
        images: [
