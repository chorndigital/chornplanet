...
export const MetadataContactEN: Metadata = {
    ...
    openGraph: {
        ...
        images: metadataLink(LanguageCode.en, MetaLinks.contact).openGraph.images,
        url: metadataLink(LanguageCode.en, MetaLinks.contact).alternates.canonical,
        type: "website"
    },
    twitter: {
        ...
        images: metadataLink(LanguageCode.en, MetaLinks.contact).twitter.images,
    },
}