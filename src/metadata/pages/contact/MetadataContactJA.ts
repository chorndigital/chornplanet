...
export const MetadataContactJA: Metadata = {
    ...
    alternates: metadataLink(LanguageCode.ja, MetaLinks.contact).alternates,
    authors: [
        {
            name: "Chorn Planet"
        }
    ...
    openGraph: {
        ...
        images: metadataLink(LanguageCode.ja, MetaLinks.contact).openGraph.images,
        url: metadataLink(LanguageCode.ja, MetaLinks.contact).alternates.canonical,
        type: "website"
    },
    twitter: {
        ...
        images: metadataLink(LanguageCode.ja, MetaLinks.contact).twitter.images,
    },
}