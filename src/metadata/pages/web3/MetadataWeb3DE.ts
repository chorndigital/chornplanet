...
export const MetadataWeb3DE: Metadata = {
    title: "Web3 Blockchain Smart Contract Entwicklung | Chorn Planet",
    ...
    openGraph: {
        title: "Web3 Blockchain Smart Contract Entwicklungsdienste | Chorn Planet",
        ...
        url: metadataLink(LanguageCode.de, MetaLinks.web3).alternates.canonical,
        type: "website",
    },
    twitter: {
    ...
    keywords: [
        ...
        "Chorn Planet", "Digitale Innovation", "Blockchain Technologie", "Skalierbare Blockchain Lösungen"
    ]
};
