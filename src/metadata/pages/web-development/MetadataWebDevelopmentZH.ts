...
export const MetadataWebDevelopmentZH: Metadata = {
    ...
    description: "探索Chorn Planet在网页开发方面的技术专长，包括Next.js、React、Angular、Vue等技术。Chorn Planet为各行各业的企业提供定制化解决方案，包括数字营销、区块链、电子商务等。",
    alternates: metadataLink(LanguageCode.zh, MetaLinks.webDevelopment).alternates,
    authors: [
        {
            name: "Chorn Planet"
        }
    ...
    openGraph: {
        title: "顶级网页开发服务 | Chorn Planet",
        description: "Chorn Planet提供前沿的网页开发技术专长，精通Next.js、React、Angular等流行框架。Chorn Planet满足各种企业需求，包括数字营销、电子商务、区块链等。",
    ...
    twitter: {
        ...
        title: "网页开发服务 | Chorn Planet",
        description: "发现Chorn Planet的网页开发专长。从Next.js到Angular等，Chorn Planet为包括数字营销、区块链、电子商务等所有商业需求提供解决方案。",
        images: metadataLink(LanguageCode.zh, MetaLinks.webDevelopment).twitter.images
    },
    keywords: [
        ...
        "泰国前端开发者", "泰国软件工程师", "Chorn Planet", "数字创新", "企业软件", "可扩展网页应用程序"
    ]
}