...
export const MetadataWebDevelopmentKO: Metadata = {
    ...
    description: "Next.js, React, Angular, Vue 등을 포함한 Chorn Planet의 웹 개발 기술 전문성을 확인하십시오. Chorn Planet은 디지털 마케팅, 블록체인, 전자 상거래 등 다양한 분야에서 기업 맞춤형 솔루션을 제공합니다.",
    ...
    openGraph: {
        title: "최고의 웹 개발 서비스 | Chorn Planet",
        description: "Chorn Planet은 Next.js, React, Angular 등 인기 있는 프레임워크에서 전문성을 가진 웹 개발 기술을 제공합니다. Chorn Planet은 디지털 마케팅, 전자 상거래, 블록체인 등 다양한 비즈니스 요구를 충족시킵니다.",
    ...
    twitter: {
        ...
        title: "웹 개발 서비스 | Chorn Planet",
        description: "Chorn Planet의 웹 개발 기술 전문성을 확인하십시오. Next.js에서 Angular까지 다양한 프레임워크를 사용하여 Chorn Planet은 디지털 마케팅, 블록체인, 전자 상거래 등 모든 비즈니스 요구에 대한 솔루션을 제공합니다.",
    ...
    keywords: [
        ...
        "태국 프론트엔드 개발자", "태국 소프트웨어 엔지니어", "Chorn Planet", "디지털 혁신", "기업 소프트웨어", "확장 가능한 웹 애플리케이션"
    ]
}