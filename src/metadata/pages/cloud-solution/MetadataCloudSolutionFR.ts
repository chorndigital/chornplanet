...
export const MetadataCloudSolutionFR: Metadata = {
    title: "Architecture de solutions cloud et analyse des systèmes | Chorn Planet | AWS, Azure, GCP, DigitalOcean",
    description: "Chorn Planet propose des services d'architecture de solutions cloud et d'analyse des systèmes avec une expertise technique avancée. Nous optimisons les infrastructures cloud sur AWS, Azure, GCP et DigitalOcean pour garantir des performances optimales, une évolutivité et une rentabilité.",
    ...
    openGraph: {
        title: "Architecture de solutions cloud et analyse des systèmes | Chorn Planet",
        description: "Découvrez l'expertise de Chorn Planet en architecture de solutions cloud et analyse des systèmes. Nous concevons des solutions cloud résilientes, évolutives et optimisées sur AWS, Azure, GCP et DigitalOcean.",
    ...
    twitter: {
        ...
        title: "Architecture de solutions cloud et analyse des systèmes | Chorn Planet",
        description: "Optimisez votre infrastructure cloud avec l'expertise de Chorn Planet en architecture de solutions cloud et analyse des systèmes sur AWS, Azure, GCP et DigitalOcean.",
    ...
    keywords: [
        ...
        "Chorn Planet", "solutions cloud", "innovation numérique", "conception d'infrastructure cloud", "systèmes cloud évolutifs"
    ]
}