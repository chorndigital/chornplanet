...
export const MetadataReactTH: Metadata = {
    ...
    keywords: [
        ...
        "การพัฒนา React แบบฟูลสแต็ค", "แอปพลิเคชันแบบหน้าเดียว React", "อินเตอร์เฟซผู้ใช้ React", "แอปพลิเคชันเว็บแบบกำหนดเอง",
        "การพัฒนาซอฟต์แวร์แบบกำหนดเอง",
        "แอปพลิเคชันเว็บที่สามารถขยายได้", "การพัฒนา Frontend", "แอปพลิเคชันเว็บที่มีประสิทธิภาพสูง",
