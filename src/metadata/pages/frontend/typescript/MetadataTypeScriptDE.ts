...
export const MetadataTypeScriptDE: Metadata = {
    title: "TypeScript | Chorn Planet - Experten für maßgeschneiderte Softwareentwicklung",
    ...
    openGraph: {
        title: "Chorn Planet - Maßgeschneiderte Softwareentwicklung mit TypeScript",
    ...
    twitter: {
        ...
        title: "Chorn Planet - TypeScript-Entwicklung für maßgeschneiderte Softwarelösungen",
