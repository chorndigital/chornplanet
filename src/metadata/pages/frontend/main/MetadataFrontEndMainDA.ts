...
export const MetadataFrontEndMainDA: Metadata = {
    title: "Frontend Udviklingstjenester | Chorn Planet",
    description: "Chorn Planet tilbyder ekspertise inden for frontend-udvikling med moderne frameworks som Next.js, React, Angular, Vue, HTML5 og CSS3. Byg responsive og skalerbare websites med de nyeste teknologier.",
    ...
    openGraph: {
        title: "Frontend Udviklingstjenester | Chorn Planet",
        description: "Chorn Planet tilbyder frontend-udvikling med moderne teknologier som Next.js, React, Angular, Vue, HTML5 og CSS3 for at skabe hurtige, responsive og skalerbare websites.",
    ...
    twitter: {
        ...
        title: "Frontend Udviklingstjenester | Chorn Planet",
        description: "Ekspertise i frontend-udvikling fra Chorn Planet ved brug af Next.js, React, Angular, Vue, HTML5 og CSS3 til responsive og skalerbare websites.",
    ...
    keywords: [
        ...
        "Chorn Planet", "digital innovation", "enterprise software", "skalerbare webapplikationer"
    ]
}