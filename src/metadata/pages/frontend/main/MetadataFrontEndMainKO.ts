...
export const MetadataFrontEndMainKO: Metadata = {
    title: "프론트엔드 개발 서비스 | Chorn Planet",
    description: "Chorn Planet은 Next.js, React, Angular, Vue, HTML5, CSS3와 같은 최신 프레임워크를 활용한 전문적인 프론트엔드 개발 서비스를 제공합니다. 최신 기술로 반응형 및 확장 가능한 웹사이트를 구축하세요.",
    ...
    openGraph: {
        title: "프론트엔드 개발 서비스 | Chorn Planet",
        description: "Chorn Planet은 Next.js, React, Angular, Vue, HTML5, CSS3 등의 최신 기술을 활용하여 빠르고 반응형이며 확장 가능한 웹사이트를 구축하는 프론트엔드 개발 전문성을 제공합니다.",
    ...
    twitter: {
        ...
        title: "프론트엔드 개발 서비스 | Chorn Planet",
        description: "Chorn Planet의 프론트엔드 개발 전문성을 활용하여 Next.js, React, Angular, Vue, HTML5, CSS3를 사용한 반응형 및 확장 가능한 웹사이트를 구축하세요.",
    ...
    keywords: [
        ...
        "Chorn Planet", "디지털 혁신", "기업 소프트웨어", "확장 가능한 웹 애플리케이션"
    ]
}