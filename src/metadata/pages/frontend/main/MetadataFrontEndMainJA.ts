...
export const MetadataFrontEndMainJA: Metadata = {
    title: "フロントエンド開発サービス | Chorn Planet",
    description: "Chorn Planetは、Next.js、React、Angular、Vue、HTML5、CSS3などの最新フレームワークを活用した専門的なフロントエンド開発サービスを提供します。レスポンシブでスケーラブルなWebサイトを最先端技術で構築。",
    ...
    openGraph: {
        title: "フロントエンド開発サービス | Chorn Planet",
        description: "Chorn Planetは、Next.js、React、Angular、Vue、HTML5、CSS3を活用し、高速でレスポンシブかつスケーラブルなWebサイトを構築するフロントエンド開発サービスを提供します。",
    ...
    twitter: {
        ...
        title: "フロントエンド開発サービス | Chorn Planet",
        description: "Chorn Planetのフロントエンド開発専門技術で、Next.js、React、Angular、Vue、HTML5、CSS3を活用し、レスポンシブでスケーラブルなWebサイトを構築。",
    ...
    keywords: [
        ...
        "Chorn Planet", "デジタルイノベーション", "エンタープライズソフトウェア", "スケーラブルWebアプリケーション"
    ]
}