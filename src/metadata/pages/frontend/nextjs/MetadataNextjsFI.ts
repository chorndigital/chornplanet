...
export const MetadataNextjsFI: Metadata = {
    title: "Next.js Kehityspalvelut | Chorn Planet",
    ...
    openGraph: {
        title: "Next.js Kehitys | Chorn Planet",
        ...
        url: metadataLink(LanguageCode.fi, MetaLinks.frontend.nextjs).alternates.canonical,
        type: "website"
    },
    twitter: {
