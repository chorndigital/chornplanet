...
export const MetadataTermOfServiceZH: Metadata = {
    title: "服务条款 | Chorn Planet",
    description: "Chorn Planet 提供服务条款以规范本网站的使用。访问或使用本网站即表示您同意遵守这些条款。",
    icons: {
        icon: '/favicon.ico',
    },
    ...
    openGraph: {
        ...
        url: metadataLink(LanguageCode.zh, MetaLinks.termOfServices).alternates.canonical,
        type: "website",
    },
    twitter: {
