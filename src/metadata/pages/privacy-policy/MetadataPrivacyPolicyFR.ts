...
export const MetadataPrivacyPolicyFR: Metadata = {
    title: "Politique de confidentialité | Chorn Planet",
    description: "Chorn Planet respecte votre vie privée et s'engage à protéger vos données personnelles. Cette politique de confidentialité explique comment les données sont traitées lors de l'utilisation du site Web et l'utilisation des cookies à des fins d'analyse.",
    icons: {
        icon: '/favicon.ico',
    },
