...
export const MetadataPrivacyPolicyZH: Metadata = {
    title: "隐私政策 | Chorn Planet",
    description: "Chorn Planet 尊重您的隐私，并致力于保护您的个人数据。本隐私政策解释了在使用网站时如何处理数据，以及出于分析目的使用 Cookie。",
    icons: {
        icon: '/favicon.ico',
    },
    ...
    openGraph: {
        ...
        url: metadataLink(LanguageCode.zh, MetaLinks.privacyPolicy).alternates.canonical,
        type: "website",
    },
    twitter: {
