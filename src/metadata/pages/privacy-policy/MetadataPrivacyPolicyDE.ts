...
export const MetadataPrivacyPolicyDE: Metadata = {
    title: "Datenschutzrichtlinie | Chorn Planet",
    description: "Chorn Planet respektiert Ihre Privatsphäre und verpflichtet sich zum Schutz Ihrer personenbezogenen Daten. Diese Datenschutzrichtlinie erklärt, wie Daten bei der Nutzung der Website verarbeitet werden und die Verwendung von Cookies zu Analysezwecken.",
    icons: {
        icon: '/favicon.ico',
    },
