...
export const MetadataPrivacyPolicyEN: Metadata = {
    title: "Privacy Policy | Chorn Planet",
    description: "Chorn Planet respects your privacy and is committed to protecting your personal data. This privacy policy explains how any data is handled when using the website and the use of cookies for analytical purposes.",
    icons: {
        icon: '/favicon.ico',
    },
