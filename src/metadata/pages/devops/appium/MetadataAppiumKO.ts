...
export const MetadataAppiumKO: Metadata = {
    title: "Appium 테스트 서비스 | Chorn Planet",
    ...
    openGraph: {
        ...
        url: metadataLink(LanguageCode.ko, MetaLinks.devops.appium).alternates.canonical,
        type: "website"
    },
    twitter: {
    ...
    keywords: [
        "Appium 테스트", "모바일 앱 테스트", "Chorn Planet", "Cloud DevOps",
