...
export const MetadataJenkinsFR: Metadata = {
    title: "Services DevOps Jenkins | Chorn Planet",
    ...
    twitter: {
        ...
        title: "Services DevOps Jenkins | Chorn Planet",
        description: "Améliorez votre cycle de développement logiciel avec l'expertise technique DevOps basée sur Jenkins de Chorn Planet pour l'automatisation CI/CD.",
