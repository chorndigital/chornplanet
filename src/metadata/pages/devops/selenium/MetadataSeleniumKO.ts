...
export const MetadataSeleniumKO: Metadata = {
    title: "Selenium 테스트 서비스 | Chorn Planet",
    ...
    openGraph: {
        title: "Selenium 테스트 | Chorn Planet",
        ...
        url: metadataLink(LanguageCode.ko, MetaLinks.devops.selenium).alternates.canonical,
        type: "website"
    },
    twitter: {
    ...
    keywords: [
        "Selenium 테스트", "자동화된 테스트", "Chorn Planet", "Cloud DevOps",
