...
export const MetadataPostmanNL: Metadata = {
    title: "Postman API Testdiensten | Chorn Planet",
    ...
    openGraph: {
        ...
        url: metadataLink(LanguageCode.nl, MetaLinks.devops.postman).alternates.canonical,
        type: "website"
    },
    twitter: {
    ...
    keywords: [
        "Postman API-test", "Postman technische expertise", "API-test", "DevOps", "Geautomatiseerde API-testen", "Chorn Planet",
