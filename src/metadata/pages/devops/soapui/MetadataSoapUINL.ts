...
export const MetadataSoapUINL: Metadata = {
    title: "SoapUI Testdiensten | Chorn Planet",
    ...
    openGraph: {
        title: "SoapUI Testen | Chorn Planet",
        ...
        url: metadataLink(LanguageCode.nl, MetaLinks.devops.soapui).alternates.canonical,
        type: "website"
    },
    twitter: {
    ...
    keywords: [
        "SoapUI testen", "API testen", "Chorn Planet", "Cloud DevOps",
