...
export const MetadataSoapUIJA: Metadata = {
    title: "SoapUIテストサービス | Chorn Planet",
    ...
    openGraph: {
        ...
        url: metadataLink(LanguageCode.ja, MetaLinks.devops.soapui).alternates.canonical,
        type: "website"
    },
    twitter: {
    ...
    keywords: [
        "SoapUIテスト", "APIテスト", "Chorn Planet", "Cloud DevOps",
