...
export const MetadataSoapUIKO: Metadata = {
    title: "SoapUI 테스트 서비스 | Chorn Planet",
    ...
    openGraph: {
        ...
        url: metadataLink(LanguageCode.ko, MetaLinks.devops.soapui).alternates.canonical,
        type: "website"
    },
    twitter: {
    ...
    keywords: [
        "SoapUI 테스트", "API 테스트", "Chorn Planet", "Cloud DevOps",
