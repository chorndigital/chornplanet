...
export const MetadataHomeKO: Metadata = {
    title: "Chorn Planet | 시스템 및 응용 기술을 위한 미디어 플랫폼",
    description:
        "Chorn Planet은 시스템 분석, 소프트웨어 엔지니어링, 통합 실무, 그리고 응용 기술 주제를 구조적으로 설명하는 미디어 플랫폼이다. AI 기반 자동화, 클라우드 시스템, 시스템 현대화 접근을 포함하며, 공공, 투자자, 정책 관련 맥락에서 활용할 수 있는 정보를 제공한다.",
    icons: {
        icon: '/favicon.ico',
    },
    ...
    keywords: [
        "Chorn Planet", "Chorn Planet", "미디어 플랫폼", "시스템 분석",
