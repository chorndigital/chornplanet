...
export const MetadataHomeFI: Metadata = {
    ...
    keywords: [
        ...
        "ohjelmistoinsinöörin johtaja", "ohjelmistoinsinöörin johtaja Thaimaa", "IT-projektipäällikkö",
        "ohjelmistokehitysjohtaja", "teknologiajohtaja", "järjestelmäanalyytikko",

        "Next.js-kehittäjä", "React.js-kehittäjä", "Spring Boot", "frontend-framework", "frontend-arkkitehtuuri",
        "full-stack verkkokehittäjä", "frontend-backend kehitys", "mikropalvelut",

        "ulkoistamisen kehitys", "ulkoistamisyritys Thaimaassa", "ohjelmointiin ulkoistaminen",
        "ulkoistettu ohjelmointitehtävät", "ulkoistetut ohjelmointityöt", "ulkoistetut ohjelmointitehtävät",
        "online-ulkoistamisohjelma"
    ]
}