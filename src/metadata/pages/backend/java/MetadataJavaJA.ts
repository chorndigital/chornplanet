...
export const MetadataJavaJA: Metadata = {
    title: "Java Spring Boot フルスタック開発 | Chorn Planet",
    ...
    openGraph: {
        title: "Java Spring Boot 開発 | Chorn Planet",
        ...
        url: metadataLink(LanguageCode.ja, MetaLinks.backend.java).alternates.canonical,
        type: "website"
    },
    twitter: {
