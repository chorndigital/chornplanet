...
export const MetadataServicePackagesFI: Metadata = {
    ...
    keywords: [
        "Chorn Planet", "Chorn Planet ohjelmistokehitys", "ohjelmistojen ulkoistus", "Web3 kehittäjä", "NFT kehitys", "lohkoketjuohjelmistot",
    ...
    twitter: {
        ...
        description: "Chorn Planet tarjoaa huippuluokan ohjelmistokehityspalveluita yrityksille Suomessa ja kansainvälisesti.",
