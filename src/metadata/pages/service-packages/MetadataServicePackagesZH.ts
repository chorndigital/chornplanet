...
export const MetadataServicePackagesZH: Metadata = {
    ...
    description: "Chorn Planet提供创新的软件开发服务套餐，支持Web3、区块链、NFT等现代技术。",
    ...
    twitter: {
        ...
        title: "Chorn Planet 服务套餐 - 软件开发与Web3",
        description: "支持定制开发、NFT、区块链和现代系统升级的专业服务。",
        images: metadataLink(LanguageCode.zh, MetaLinks.servicePackages).twitter.images,
    },
    keywords: [
        // 品牌关键词
        "Chorn Planet", "Chorn Planet 定制软件开发", "Chorn Planet 软件外包", "Chorn Planet 是什么",
        "Chorn Planet 泰国软件开发", "Chorn Planet 清迈开发者", "Chorn Planet 曼谷开发者",
