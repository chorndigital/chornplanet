...
export const MetadataAiFahZH: Metadata = {
    title: "AI聊天助手 | Chorn Planet AI集成",
    ...
    alternates: metadataLink(LanguageCode.zh, MetaLinks.aiFah).alternates,
    authors: [
        {
            name: "Chorn Planet"
        }
    ...
    twitter: {
        ...
        images: metadataLink(LanguageCode.zh, MetaLinks.aiFah).twitter.images,
    },
}