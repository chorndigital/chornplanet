...
export const MetaPlazaThatConnectsTheHubKO: Metadata = {
    title: "허브를 연결하는 광장 | 치앙마이 스마트 시티 시나리오",
    description:
        "치앙마이의 스마트 시티를 가정한 시나리오로, 이동 허브가 공공 광장으로 확장되어 이동 목적이 없어도 사람들이 찾는 공간이 됩니다.",
    ...
    openGraph: {
        ...
        description:
            "이동 인프라가 공공 공간을 형성하고 도시 생활을 지원하는 시나리오.",
    ...
    twitter: {
        ...
        title: "허브를 연결하는 광장 | 치앙마이",
        description:
            "이동 시스템이 공공의 장소를 만들어내는 스마트 시티 시나리오.",
        images: [
