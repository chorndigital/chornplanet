...
export const MetaPlazaThatConnectsTheHubFI: Metadata = {
    title: "Aukio, joka yhdistää liikenteen solmukohdan | Chiang Mai -älykaupunkiskenaario",
    description:
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "Julkinen aukio liikenteen solmukohdan yhteydessä Chiang Maissa",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "Aukio, joka yhdistää liikenteen solmukohdan | Chiang Mai",
        description:
            "Liikkuminen kaupunkitilan ja arjen kohtaamispaikkana.",
        images: [
