...
export const MetaPlazaThatConnectsTheHubJA: Metadata = {
    title: "ハブをつなぐプラザ｜チェンマイ・スマートシティシナリオ",
    description:
    ...
    twitter: {
        ...
        title: "ハブをつなぐプラザ｜チェンマイ",
        description:
            "移動インフラが公共の場を形成するスマートシティシナリオ。",
        images: [
