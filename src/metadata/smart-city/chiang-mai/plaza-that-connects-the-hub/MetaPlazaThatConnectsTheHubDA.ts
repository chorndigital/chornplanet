...
export const MetaPlazaThatConnectsTheHubDA: Metadata = {
    title: "Pladsen der forbinder knudepunktet | Smart city-scenarie i Chiang Mai",
    description:
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "Offentlig plads forbundet med et mobilitetsknudepunkt i Chiang Mai",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "Pladsen der forbinder knudepunktet | Chiang Mai",
        description:
            "Mobilitet som grundlag for offentlige byrum og sociale mødesteder.",
        images: [
