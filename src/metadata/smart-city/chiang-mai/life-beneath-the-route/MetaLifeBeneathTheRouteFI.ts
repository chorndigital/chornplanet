...
export const MetaLifeBeneathTheRouteFI: Metadata = {
    title: "Elämää liikkumisreitin alla | Chiang Mai -älykaupunkiskenaario",
    description:
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "Kaupunkielämää liikkumisreitin alla Chiang Maissa",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "Elämää liikkumisreitin alla | Chiang Mai",
        description:
            "Skenaario, jossa liikkuminen tukee arkea huomaamattomasti.",
        images: [
