...
export const MetaLifeBeneathTheRouteJA: Metadata = {
    title: "移動ルートの下で営まれる暮らし｜チェンマイ・スマートシティシナリオ",
    description:
    ...
    twitter: {
        ...
        title: "移動ルートの下で営まれる暮らし｜チェンマイ",
        description:
            "移動システムが日常生活を自然に支える都市シナリオ。",
        images: [
