...
export const MetaLifeBeneathTheRouteTH: Metadata = {
    title: "ชีวิตใต้เส้นทางคมนาคม | ฉากเมืองอัจฉริยะเชียงใหม่",
    description:
        "ฉากจำลองเมืองอัจฉริยะในเชียงใหม่ ที่โครงสร้างการคมนาคมถูกออกแบบให้เป็นส่วนหนึ่งของชีวิตประจำวัน รองรับการเดิน การพักผ่อน และการใช้พื้นที่ในระดับมนุษย์",
    ...
    openGraph: {
        title: "ชีวิตใต้เส้นทางคมนาคม – ฉากเมืองอัจฉริยะเชียงใหม่",
        description:
            "ภาพสะท้อนการออกแบบโครงสร้างการเดินทางที่ผสานเข้ากับชีวิตเมืองอย่างเป็นธรรมชาติ",
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "ชีวิตประจำวันของผู้คนใต้โครงสร้างการคมนาคมในเชียงใหม่",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "ชีวิตใต้เส้นทางคมนาคม | เมืองอัจฉริยะเชียงใหม่",
        description:
            "ฉากจำลองเมืองที่การคมนาคมสนับสนุนชีวิตประจำวันอย่างกลมกลืน",
        images: [
