...
export const MetaLifeBeneathTheRouteZHCN: Metadata = {
    title: "移动通道下的城市生活｜清迈智慧城市情景",
    description:
        "一个关于清迈智慧城市的示意性情景，其中交通基础设施被自然地融入日常城市生活结构之中。",
