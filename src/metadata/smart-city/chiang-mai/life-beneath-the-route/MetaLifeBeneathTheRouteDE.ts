...
export const MetaLifeBeneathTheRouteDE: Metadata = {
    title: "Leben unter der Mobilitätsroute | Smart-City-Szenario Chiang Mai",
    description:
        "Ein illustratives Smart-City-Szenario in Chiang Mai, in dem Mobilitätsinfrastruktur Teil des alltäglichen urbanen Lebens wird.",
    ...
    openGraph: {
        ...
        description:
            "Mobilität als integrierter Bestandteil des öffentlichen Raums und des täglichen Lebens.",
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "Alltägliches Stadtleben unter Mobilitätsinfrastruktur in Chiang Mai",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "Leben unter der Mobilitätsroute | Chiang Mai",
        description:
            "Ein Smart-City-Szenario, in dem Mobilität den urbanen Alltag unterstützt.",
        images: [
