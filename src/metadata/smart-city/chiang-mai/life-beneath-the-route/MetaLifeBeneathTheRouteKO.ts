...
export const MetaLifeBeneathTheRouteKO: Metadata = {
    title: "이동 경로 아래의 삶 | 치앙마이 스마트 시티 시나리오",
    description:
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "치앙마이의 이동 인프라 아래에서 이루어지는 도시 생활",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "이동 경로 아래의 삶 | 치앙마이",
        description:
            "이동 시스템이 일상 생활을 자연스럽게 뒷받침하는 도시 시나리오.",
        images: [
