...
export const MetaLifeBeneathTheRouteDA: Metadata = {
    title: "Livet under mobilitetsruten | Smart city-scenarie i Chiang Mai",
    description:
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "Hverdagsliv under mobilitetsinfrastruktur i Chiang Mai",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "Livet under mobilitetsruten | Chiang Mai",
        description:
            "Et scenarie hvor mobilitet understøtter hverdagslivet i menneskelig skala.",
        images: [
