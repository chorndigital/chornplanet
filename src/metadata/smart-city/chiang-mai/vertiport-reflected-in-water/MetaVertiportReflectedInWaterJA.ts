...
export const MetaVertiportReflectedInWaterJA: Metadata = {
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "水面に映る、チェンマイの都市景観に統合されたバーティポート",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "水面に映るバーティポート｜チェンマイ・スマートシティ",
        description:
            "静けさと環境との調和を重視して設計された、チェンマイのバーティポートを描く想定シナリオ。",
        images: [
