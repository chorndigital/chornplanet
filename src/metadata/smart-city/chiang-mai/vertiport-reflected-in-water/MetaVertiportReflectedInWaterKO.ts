...
export const MetaVertiportReflectedInWaterKO: Metadata = {
    title: "물에 비친 버티포트 | 치앙마이 스마트 시티 시나리오",
    description:
        "치앙마이의 스마트 모빌리티 시나리오로, 버티포트가 도시 환경에 차분하게 통합되어 절제된 디자인을 통해 안정성, 정밀성, 신뢰를 전달합니다.",

    alternates: {
        canonical: "/ko/smart-city/chiang-mai/vertiport-reflected-in-water/",
        languages: {
    ...
    openGraph: {
        title: "물에 비친 버티포트 – 치앙마이 스마트 시티 시나리오",
        description:
            "첨단 항공 모빌리티 인프라가 치앙마이의 도시 환경에 조용하고 신뢰감 있게 통합되는 모습을 보여주는 차분한 버티포트 시나리오입니다.",
        url: "/ko/smart-city/chiang-mai/vertiport-reflected-in-water/",
        type: "website",
        images: [
            {
    ...
    twitter: {
        ...
        title: "물에 비친 버티포트 | 치앙마이 스마트 시티",
        description:
            "차분한 자신감과 환경적 통합을 기반으로 설계된 치앙마이의 버티포트를 보여주는 시나리오.",
        images: [
