...
export const MetaVertiportReflectedInWaterFI: Metadata = {
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "Veteportti veden heijastuksessa Chiang Main kaupunkimaisemassa",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "Veteportti veden heijastuksessa | Chiang Mai Smart City",
        description:
            "Havainnollistava skenaario veteportista Chiang Maissa, suunniteltu rauhallisesti ja ympäristöön sulautuen.",
        images: [
