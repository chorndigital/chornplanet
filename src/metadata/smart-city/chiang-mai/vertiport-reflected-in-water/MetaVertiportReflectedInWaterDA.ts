...
export const MetaVertiportReflectedInWaterDA: Metadata = {
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "Vertiport spejlet i vand, integreret i Chiang Mais bylandskab",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "Vertiport spejlet i vand | Chiang Mai Smart City",
        description:
            "Et illustrativt scenarie, der viser en vertiport i Chiang Mai designet med ro, præcision og miljømæssig integration.",
        images: [
