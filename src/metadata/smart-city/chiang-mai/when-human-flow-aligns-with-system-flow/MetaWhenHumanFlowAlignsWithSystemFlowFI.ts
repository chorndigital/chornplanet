...
export const MetaWhenHumanFlowAlignsWithSystemFlowFI: Metadata = {
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "Ihmisten liike ja liikkumisjärjestelmät tasapainossa Chiang Main älykaupunkimaisemassa",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "Kun ihmisten liike on linjassa järjestelmän kanssa | Älykaupunki Chiang Mai",
        description:
            "Havainnollistava älykaupunkiskenaario, jossa ihmisten liike ja mukautuvat liikkumisjärjestelmät toimivat rytmissä.",
        images: [
