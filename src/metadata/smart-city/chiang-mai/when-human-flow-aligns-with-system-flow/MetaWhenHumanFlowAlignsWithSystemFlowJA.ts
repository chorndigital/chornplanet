...
export const MetaWhenHumanFlowAlignsWithSystemFlowJA: Metadata = {
    title: "人の流れとシステムが調和するとき｜チェンマイ・スマートシティ・シナリオ",
    description:
        "チェンマイにおけるスマートシティの概念的シナリオ。人の移動とモビリティシステムが調和して機能し、適応型インフラによって直感的な移動体験を支えます。",

    alternates: {
        canonical: "/ja/smart-city/chiang-mai/when-human-flow-aligns-with-system-flow",
        languages: {
    ...
    openGraph: {
        title: "人の流れとシステムが調和するとき ― チェンマイ・スマートシティ・シナリオ",
        description:
            "チェンマイにおいて、モビリティシステムが人の動きに静かに適応し、快適性・安全性・明確さを日常都市生活の中で支える様子を示すシナリオ。",
        url: "/ja/smart-city/chiang-mai/when-human-flow-aligns-with-system-flow",
        type: "website",
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "チェンマイのスマートシティ環境における人の流れとモビリティシステムの調和",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "人の流れとシステムが調和するとき｜チェンマイ・スマートシティ",
        description:
            "人の移動と適応型モビリティシステムが調和して機能するスマートシティの概念的シナリオ。",
        images: [
