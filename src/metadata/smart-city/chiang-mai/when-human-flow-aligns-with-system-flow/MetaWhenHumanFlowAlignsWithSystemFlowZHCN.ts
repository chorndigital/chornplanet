...
export const MetaWhenHumanFlowAlignsWithSystemFlowZHCN: Metadata = {
    title: "当人流与系统流动协调一致｜清迈智慧城市情景",
    description:
        "一个清迈智慧城市的概念性情景，在此人类出行与交通系统协调运行，通过自适应基础设施支持直观而顺畅的移动体验。",

    alternates: {
        canonical: "/zh-cn/smart-city/chiang-mai/when-human-flow-aligns-with-system-flow",
        languages: {
    ...
    openGraph: {
        title: "当人流与系统流动协调一致 — 清迈智慧城市情景",
        description:
            "该情景展示了清迈的交通系统如何安静地适应人类出行需求，在日常城市生活中支持舒适性、安全性与清晰性。",
        url: "/zh-cn/smart-city/chiang-mai/when-human-flow-aligns-with-system-flow",
        type: "website",
        images: [
            {
    ...
    twitter: {
        ...
        title: "当人流与系统流动协调一致｜清迈智慧城市",
        description:
            "一个展示人类出行与自适应交通系统协调运行的智慧城市情景。",
        images: [
