...
export const MetaWhenHumanFlowAlignsWithSystemFlowKO: Metadata = {
    title: "사람의 흐름과 시스템이 조화를 이룰 때 | 치앙마이 스마트 시티 시나리오",
    description:
        "치앙마이의 스마트 시티를 가정한 시나리오로, 사람의 이동과 모빌리티 시스템이 리듬을 이루며 적응형 인프라가 직관적인 이동을 지원합니다.",

    alternates: {
        canonical: "/ko/smart-city/chiang-mai/when-human-flow-aligns-with-system-flow",
        languages: {
    ...
    openGraph: {
        title: "사람의 흐름과 시스템이 조화를 이룰 때 – 치앙마이 스마트 시티 시나리오",
        description:
            "치앙마이에서 모빌리티 시스템이 사람의 움직임에 조용히 적응하며 일상 도시 생활의 편안함과 안전, 명확성을 지원하는 모습을 보여주는 시나리오입니다.",
        url: "/ko/smart-city/chiang-mai/when-human-flow-aligns-with-system-flow",
        type: "website",
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "치앙마이 스마트 시티 환경에서 조화를 이루는 사람의 이동과 모빌리티 시스템",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "사람의 흐름과 시스템이 조화를 이룰 때 | 치앙마이 스마트 시티",
        description:
            "사람의 이동과 적응형 모빌리티 시스템이 조화를 이루는 스마트 시티 시나리오.",
        images: [
