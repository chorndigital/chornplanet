...
export const MetaTheCityInBalanceDA: Metadata = {
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "Balanceret smart city-landskab i Chiang Mai formet af integrerede mobilitetssystemer",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "Byen i Balance | Chiang Mai Smart City",
        description:
            "Et afsluttende smart city-scenarie, hvor mobilitet og hverdagsliv i Chiang Mai fungerer i balance og kontinuitet.",
        images: [
