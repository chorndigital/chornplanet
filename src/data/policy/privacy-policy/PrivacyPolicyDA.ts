...
export const PrivacyPolicyDA: IPolicy = {
    ...
    contents: [
        ...
        },
        {
            ...
            details: [
                {
                    title: "2.1 Anvendelse af cookies",
                    description:
                        "Websitet anvender kun cookies, når der er givet udtrykkeligt samtykke via Cookie Consent-modalen. Cookies er små tekstfiler, der lagres på brugerens enhed, og anvendes udelukkende til at understøtte en grundlæggende analytisk forståelse af brugen og ydeevnen af websitet."
                },
                {
                ...
                },
                {
                    ...
                    description:
                        "Brugere kan til enhver tid acceptere eller afvise cookies via Cookie Consent-modalen. Cookie-indstillinger kan desuden administreres via browserens egne indstillinger. Afvisning af cookies begrænser ikke adgangen til websitet, men kan medføre, at der ikke indsamles samlede brugsdata til forbedring af websitet."
                }
            ]
        },
        {
        ...
        {
            title: "5. Ændringer af privatlivspolitikken",
            description: "",
            details: [
                {
                    title: "5.1 Opdateringer af politikken",
                    description:
                        "Denne privatlivspolitik kan løbende blive opdateret for at afspejle ændringer i lovgivning eller website-praksis. Eventuelle ændringer træder i kraft ved offentliggørelse på denne side. Fortsat brug af websitet efter offentliggørelse af ændringer betragtes som anerkendelse af den reviderede privatlivspolitik."
                }
            ]
        }
    ]
