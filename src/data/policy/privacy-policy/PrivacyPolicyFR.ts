        ...
        },
        {
            ...
            details: [
                ...
                },
                {
                    ...
                    description:
                        "Lorsque le consentement est accordé, des données d’utilisation anonymisées peuvent être collectées par l’intermédiaire de services d’analyse fournis par des tiers, tels que Google Analytics. Ces données peuvent inclure des informations générales telles que les pages consultées, les schémas de navigation et des statistiques d’utilisation agrégées. Chorn Planet n’utilise pas ces données à des fins de profilage, de marketing ou de suivi inter-sites, et ne collecte pas intentionnellement de données permettant d’identifier les utilisateurs."
                },
                {
