...
export const PrivacyPolicyDE: IPolicy = {
    ...
    contents: [
            ...
            details: [
                {
                    ...
                    description:
                        "Die Website verwendet Cookies ausschließlich, wenn eine ausdrückliche Einwilligung über das Cookie-Consent-Modul erteilt wurde. Cookies sind kleine Textdateien, die auf dem Endgerät der Nutzer gespeichert werden und ausschließlich dazu dienen, ein grundlegendes analytisches Verständnis der Nutzung und Leistung der Website zu ermöglichen."
                },
                {
                ...
                },
                {
                    ...
                    description:
                        "Nutzer können Cookies jederzeit über das Cookie-Consent-Modul akzeptieren oder ablehnen. Darüber hinaus können Cookie-Einstellungen auch über die jeweiligen Browser-Einstellungen verwaltet werden. Die Ablehnung von Cookies schränkt den Zugriff auf die Website nicht ein, kann jedoch die Erfassung aggregierter Nutzungsdaten zur Verbesserung der Website einschränken."
                }
            ]
        },
        {
        ...
        },
        {
            ...
            details: [
                {
                    title: "5.1 Aktualisierungen der Richtlinie",
                    description:
                        "Diese Datenschutzerklärung kann von Zeit zu Zeit aktualisiert werden, um Änderungen rechtlicher Anforderungen oder der Website-Praxis Rechnung zu tragen. Änderungen treten mit ihrer Veröffentlichung auf dieser Seite in Kraft. Die fortgesetzte Nutzung der Website nach Veröffentlichung gilt als Kenntnisnahme der aktualisierten Datenschutzerklärung."
                }
            ]
        }
    ]
