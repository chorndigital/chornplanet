...
export const AboutKO: IAbout = {
    ...
    description: [
        {
            title: "회사 소개",
            description: "2001년부터 CHORN은 대량 전자 제조를 위한 소프트웨어 및 하드웨어 엔지니어링에 전문성을 쌓아왔으며, 월 1천만 개 단위의 출하를 지원하는 제조 실행 시스템(MES)에 대한 검증된 역량을 보유하고 있습니다. 2012년부터는 디지털 플랫폼 개발로 역량을 확장하여, 최신 기술, 프레임워크 및 프로그래밍 언어를 기반으로 확장 가능한 웹 및 모바일 솔루션을 제공하고 수백만 명의 사용자를 지원할 수 있는 스케일링 경험을 쌓았습니다. 2023년 3월에는 공식 웹사이트를 론칭하며, 혁신에 대한 지속적인 헌신과 급변하는 기술 환경 속에서 앞서 나아가려는 의지를 보여주고 있습니다."
        },
        {
            title: "전문 지식",
