...
export const AboutKO: IAbout = {
    ...
    description: [
        ...
        {
            title: "디지털 플랫폼 개발",
            description: "2012년부터 역량은 디지털 플랫폼 개발로 확장되어, 최신 기술과 프레임워크를 기반으로 한 확장 가능한 웹 및 모바일 솔루션을 제공하고 있습니다. 플랫폼은 성공적으로 확장되어 매달 수백만 명의 사용자를 지원하고 있으며, 기업 시스템 개발, 구현 및 구성과 관련된 SAP ERP 및 S/4HANA 프로젝트도 포함됩니다."
        },
        {
            title: "위치 및 근무 형태",
