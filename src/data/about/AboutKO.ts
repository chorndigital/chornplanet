...
export const AboutKO: IAbout = {
    ...
    description: [
        {
            title: "제조 실행 시스템 (MES)",
            description: "2001년에 시작된 CHORN은 대량 전자 제조를 위한 소프트웨어 및 하드웨어 엔지니어링을 전문으로 하며, 제조 실행 시스템(MES) 분야의 전문성을 통해 월 1,000만 대 이상의 생산 확장을 효율적이고 신뢰성 있게 지원하고 있습니다."
        },
        {
            title: "디지털 플랫폼 개발",
            description: "2012년부터 CHORN은 디지털 플랫폼 개발 분야로 전문성을 확장하여, 최신 기술과 프레임워크를 기반으로 한 확장 가능한 웹 및 모바일 솔루션을 구축하며 증가하는 사용자 요구를 충족해 왔습니다. 수백만 명의 월간 사용자를 지원할 수 있는 확장 아키텍처를 성공적으로 구현했으며, SAP ERP 및 S/4HANA와 관련된 기업 시스템 개발, 도입 및 구성 프로젝트도 수행했습니다."
        },
        {
            title: "위치 및 근무 형태",
