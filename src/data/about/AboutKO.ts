...
export const AboutKO: IAbout = {
    ...
    description: [
        ...
        {
            title: "디지털 플랫폼 개발",
            description: "2012년부터 CHORN은 디지털 플랫폼 개발 전문성을 확장하여 최신 기술, 프레임워크 및 클라우드 시스템을 기반으로 한 확장 가능한 웹 및 모바일 솔루션을 구축하고, 증가하는 사용자 요구를 충족해 왔습니다. 아키텍처 설계는 확장 가능하며 월 수백만 명의 사용자를 지원하고, SAP ERP 및 S/4HANA와 관련된 엔터프라이즈 시스템 개발 프로젝트도 포함됩니다."
        },
        {
            title: "위치 및 근무 형태",
