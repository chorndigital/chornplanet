...
export const AboutKO: IAbout = {
    ...
    description: [
        {
            "title": "제조 실행 시스템 (MES)",
            "description": "2001년 이후 CHORN은 대량 전자제품 제조를 위한 소프트웨어 및 하드웨어 엔지니어링을 전문으로 하며, 제조 실행 시스템(MES)에 대한 전문 지식을 바탕으로 월 1,000만 단위 이상의 생산 확장을 효율적이고 안정적으로 수행하고 있습니다."
        },
        {
            "title": "디지털 플랫폼 개발",
            "description": "2012년 이후 디지털 플랫폼 개발 역량을 확장하여 최신 기술과 프레임워크를 기반으로 한 확장 가능한 웹 및 모바일 솔루션을 제공합니다. 플랫폼은 월 수백만 방문자를 지원하도록 성공적으로 확장되었으며, SAP ERP 및 S/4HANA를 활용한 엔터프라이즈 시스템 개발, 구현 및 구성 프로젝트도 포함됩니다."
        },
        {
            "title": "공식 웹사이트 출시",
            "description": "2023년 3월 공식 웹사이트를 출시하여 지속적인 혁신에 대한 약속과 빠르게 진화하는 기술 환경에서의 리더십 유지 의지를 보여주었습니다."
        },
        {
            title: "위치 및 근무 형태",
