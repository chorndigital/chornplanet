...
export const AboutKO: IAbout = {
    ...
    description: [
        {
            title: "제조 실행 시스템 (MES)",
            description: "CHORN은 2001년에 시작하여 대량 전자 제품 제조를 위한 소프트웨어 및 하드웨어 엔지니어링 분야에서 전문성을 보유하고 있으며, 제조 실행 시스템에 특화되어 있습니다. 월 1천만 개 이상의 자동화된 생산 능력을 관리하는 프로젝트를 주도했으며, 시스템 효율성과 신뢰성을 지속적으로 개선해 왔습니다."
        },
        {
            title: "디지털 플랫폼 개발",
