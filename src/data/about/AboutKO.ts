...
export const AboutKO: IAbout = {
    ...
    description: [
        ...
        {
            title: "디지털 플랫폼 개발",
            description: "2012년 이후 CHORN은 IT 및 소프트웨어 개발 전문성을 디지털 플랫폼 개발로 확장하기 시작했으며, 최신 기술, 프레임워크 및 클라우드 시스템을 기반으로 확장 가능한 웹 및 모바일 솔루션을 구축하여 사용자들의 증가하는 요구를 충족시켰습니다. 아키텍처 설계는 확장 가능하며 수백만 명의 사용자를 지원하고, SAP ERP 및 S/4HANA와 관련된 기업 시스템 개발 프로젝트도 포함합니다."
        },
        {
            title: "AI-Power",
