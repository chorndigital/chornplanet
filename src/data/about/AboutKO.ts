...
export const AboutKO: IAbout = {
    ...
    description: [
        {
            title: "제조 실행 시스템 (MES)",
            description: "2001년에 설립된 CHORN은 대량 전자제품 제조를 위한 소프트웨어 및 하드웨어 엔지니어링, 연구개발(R&D) 엔지니어링 팀과의 하드웨어-소프트웨어-기계 설계 전문성을 보유하고 있으며, 제조 실행 시스템에 특화되어 있습니다. 월 1천만 대 이상의 자동화된 생산 능력을 관리하는 프로젝트를 주도했으며, 부서 간 팀 협업을 통해 시스템 효율성, 신뢰성 및 제품 품질의 지속적인 개선을 이끌었습니다."
        },
        {
            title: "디지털 플랫폼 개발",
