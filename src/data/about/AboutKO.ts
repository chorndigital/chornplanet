...
export const AboutKO: IAbout = {
    ...
    description: [
        {
            title: "제조 실행 시스템 (MES)",
            description: "2001년에 시작된 CHORN은 대량 전자 제조를 위한 소프트웨어 및 하드웨어 엔지니어링에 전문성을 보유하고 있으며, 제조 실행 시스템에 특화되어 있습니다. 월 1,000만 개 이상의 자동화된 생산 능력을 감독하는 프로젝트를 주도했으며, 시스템 효율성과 신뢰성을 지속적으로 개선해 왔습니다."
        },
        {
            title: "디지털 플랫폼 개발",
            description: "2012년부터 CHORN은 디지털 플랫폼 개발 분야에서 전문성을 확장해 왔으며, 최신 기술, 프레임워크 및 클라우드 시스템을 기반으로 한 확장 가능한 웹 및 모바일 솔루션을 구축하여 사용자의 증가하는 요구를 충족시켜 왔습니다. 아키텍처 설계는 확장 가능하며 수백만 명의 사용자를 지원하고, 기업 시스템 개발을 위한 SAP ERP, ECC6, 및 S/4HANA 관련 프로젝트도 포함되어 있습니다."
        },
        {
            title: "위치 및 근무 형태",
