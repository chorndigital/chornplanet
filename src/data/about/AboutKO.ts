...
export const AboutKO: IAbout = {
    ...
    description: [
        {
            title: "회사 소개",
            description: "2001년부터 CHORN은 반도체 및 전자제품 대량 생산을 위한 소프트웨어와 하드웨어 엔지니어링을 전문으로 해왔습니다. 2012년에는 최신 기술, 프레임워크, 프로그래밍 언어를 활용하여 웹 및 모바일 솔루션을 포함한 디지털 플랫폼 개발로 역량을 확장했습니다. 2023년 3월, 우리는 기술의 최신 발전, 소프트웨어 개발, 다양한 산업 분야의 IT 솔루션 및 기타 기술 트렌드에 대한 인사이트를 공유하기 위해 웹사이트를 공식적으로 개설했습니다."
        },
        {
            title: "전문 지식",
