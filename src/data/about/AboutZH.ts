...
export const AboutZH: IAbout = {
    ...
    description: [
        {
            title: "制造执行系统 (MES)",
            description: "CHORN成立于2001年，拥有在大规模电子制造领域的软件与硬件工程经验，与研发工程团队共同进行软硬件-机械设计，专注于制造执行系统。主导项目监督每月超过一千万台的自动化生产能力，推动跨职能团队协作，并在系统效率、可靠性和产品质量方面持续改进。"
        },
        {
            title: "数字平台开发",
            description: "在 2012 年后，CHORN 扩展了其在数字平台开发方面的专业能力，利用现代技术、框架和云系统创建可扩展的网页和移动解决方案，以满足用户日益增长的需求。其架构设计具备可扩展性，能够支持数百万用户，并涵盖与 SAP ERP 和 S/4HANA 相关的企业系统开发项目。"
        },
        {
            title: "工作地点和形式",
