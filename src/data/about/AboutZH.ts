...
export const AboutZH: IAbout = {
    ...
    description: [
        {
            title: "制造执行系统 (MES)",
            description: "自2001年开始，CHORN在大规模电子制造的软件和硬件工程方面具备专业知识，专注于制造执行系统。曾主导项目监督每月超过1,000万台的自动化生产能力，并持续提升系统的效率和可靠性。"
        },
        {
            title: "数字平台开发",
            description: "在 2012 年后，CHORN 扩展了其在数字平台开发方面的专业能力，利用现代技术、框架和云系统创建可扩展的网页和移动解决方案，以满足用户日益增长的需求。其架构设计具备可扩展性，能够支持数百万用户，并涵盖与 SAP ERP、ECC6 和 S/4HANA 相关的企业系统开发项目。"
        },
        {
            title: "工作地点和形式",
