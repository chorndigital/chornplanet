...
export const AboutZH: IAbout = {
    ...
    description: [
        {
            title: "关于我们",
            description: "自2001年以来，CHORN一直专注于大规模电子制造的软件和硬件工程，在制造执行系统（MES）方面具备成熟的专业能力，能够支持每月高达一千万件的出货量。自2012年起，我们扩展至数字平台开发，基于现代技术、框架和编程语言，交付可扩展的网页与移动解决方案，并积累了支持数百万用户规模的经验。2023年3月，我们正式上线官方网站，展现了我们在创新上的持续投入，以及在快速发展的技术格局中始终保持领先的承诺。"
        },
        {
            title: "专业知识",
