    ...
    description: [
        {
            ...
            description: "Started in 2001, CHORN has expertise in software and hardware engineering for high-volume electronics manufacturing, with specialization in manufacturing execution systems. Led projects overseeing automated production capacity of more than 10 million units per month, with continuous improvements in system efficiency and reliability."
        },
        {
            title: "Digital Platform Development",
            description: "Later in 2012, CHORN has expanded its expertise in digital platform development, creating scalable web and mobile solutions built on modern technologies, frameworks, and cloud systems to meet the growing needs of users. The architecture design is scalable and supports millions of users, including projects related to SAP ERP, ECC6, and S/4HANA for enterprise system development."
        },
        {
