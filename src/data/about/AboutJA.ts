...
export const AboutJA: IAbout = {
    ...
    description: [
        ...
        },
        {
            ...
            description: "2012年以降、CHORNはITおよびソフトウェア開発の専門性を拡大し、デジタルプラットフォーム開発に取り組み、最新の技術、フレームワーク、クラウドシステムを活用したスケーラブルなWebおよびモバイルソリューションを構築し、ユーザーの増大するニーズに応えてきました。アーキテクチャ設計はスケーラブルであり、数百万人のユーザーをサポートし、企業システム開発のためのSAP ERPおよびS/4HANAに関連するプロジェクトも含まれています。"
        },
        {
            title: "AI-Power",
