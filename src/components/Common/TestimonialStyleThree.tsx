  ...
  return (
    <>
      <div
        ...
        style={{
          backgroundImage: `url(/obsolete-images/client-bg.jpg)`,
        }}
      >
          ...
          >
            <SwiperSlide>
              <div className="client-item">
                ...
                <div className="client-info">
                  <Image
                    src="/obsolete-images/client/client-1.jpg"
                    alt="image"
                    width={300}
                    height={300}
                  />
            ...
            <SwiperSlide>
              <div className="client-item">
                ...
                <div className="client-info">
                  <Image
                    src="/obsolete-images/client/client-2.jpg"
                    alt="image"
                    width={300}
                    height={300}
                  />
            ...
            <SwiperSlide>
              <div className="client-item">
                ...
                <div className="client-info">
                  <Image
                    src="/obsolete-images/client/client-3.jpg"
                    alt="image"
                    width={300}
                    height={300}
                  />
