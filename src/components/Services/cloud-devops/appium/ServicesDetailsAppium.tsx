                    ...
                    <div className="row">
                        <div className="col-lg-8 col-md-12">
                            <div className="services-details-desc">
                                <h1>{InfoTranslation[lang].DevOps.appium.features[0].title}</h1>
                                <p>{InfoTranslation[lang].DevOps.appium.features[0].description}</p>

                                <h2 className="pt-4">{InfoTranslation[lang].DevOps.appium.features[1].title}</h2>
                                <p>{InfoTranslation[lang].DevOps.appium.features[1].description}</p>

                                <div className="services-details-features">
                                    <div className="row align-items-center">
                                        <Image
                                            src={ImageUrl.devops.frameworks.appium.image1200}
                                            alt="image"
                                            width={500}
                                            height={500}
                                        />
                                        ...
                                        <div className="col-lg-6">
                                            <ul className="feature-list">
                                                {InfoTranslation[lang].DevOps.appium.features[1].list.map((item: string, index: number) => (
