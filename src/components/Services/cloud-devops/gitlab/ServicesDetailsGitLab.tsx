...
export default function ServicesDetailsGitLab({lang}: { lang: string }) {
    return (
        <>
                    ...
                    <div className="row">
                        <div className="col-lg-8 col-md-12">
                            <div className="services-details-desc">
                                <h1>{InfoTranslation[lang].DevOps.gitlab.features[0].title}</h1>
                                <p>{InfoTranslation[lang].DevOps.gitlab.features[0].description}</p>

                                <h2 className="pt-4">{InfoTranslation[lang].DevOps.gitlab.features[1].title}</h2>
