...
export default function ServicesDetailsPostman({lang}: { lang: string }) {
    return (
        <>
                        ...
                        <div className="col-lg-8 col-md-12">
                            <div className="services-details-desc">
                                ...
                                <div className="text-result">
                                    <h3>{InfoTranslation[lang].DevOps.postman.features[2].title}</h3>
                                    <p>{InfoTranslation[lang].DevOps.postman.features[2].description}</p>
                                </div>
                                <ServiceFaqPostman lang={lang}/>
                            </div>
                        </div>
