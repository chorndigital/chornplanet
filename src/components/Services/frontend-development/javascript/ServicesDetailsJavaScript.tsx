...
export default function ServicesDetailsJavaScript({lang, stack, frontEnd, fullStack, devOps}: { lang: string, stack: IFrontEndStack, frontEnd: IFrontEnd, fullStack: IFullStack, devOps: IDevOps }) {
    return (
        <FrontEndServiceDetails
            lang={lang}
            stack={stack}
            image={ImageUrl.frontend.frameworks.javascript.image1200}
        frontEnd={frontEnd}
            fullStack={fullStack}
            devOps={devOps}
        />
