...
export default function ServicesDetailsHtml5({lang, stack, frontEnd, fullStack, devOps}: { lang: string, stack: IFrontEndStack, frontEnd: IFrontEnd, fullStack: IFullStack, devOps: IDevOps }) {
    return (
