...
export default function ServicesDetailsPython({lang, stack, frontEnd, fullStack, devOps}: { lang: string, stack: IFullStackStack, frontEnd: IFrontEnd, fullStack: IFullStack, devOps: IDevOps }) {
    return (
