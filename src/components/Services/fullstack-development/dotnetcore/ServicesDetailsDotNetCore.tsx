                    ...
                    <div className="row">
                        <div className="col-lg-8 col-md-12">
                            <div className="services-details-desc">
                                <h1>{InfoTranslation[lang].FullStack.dotnetcore.features[0].title}</h1>
                                <p>{InfoTranslation[lang].FullStack.dotnetcore.features[0].description}</p>

                                <h2 className="pt-4">{InfoTranslation[lang].FullStack.dotnetcore.features[1].title}</h2>
                                <p>{InfoTranslation[lang].FullStack.dotnetcore.features[1].description}</p>

                                <div className="services-details-features">
                                    <div className="row align-items-center">
                                        <Image
                                            src={ImageUrl.backend.frameworks.dotnetcore.image1200}
                                            alt="image"
                                            width={500}
                                            height={500}
                                        />
                                ...
                                <ServiceFaqDotNetCore lang={lang}/>
                            </div>
                        </div>
