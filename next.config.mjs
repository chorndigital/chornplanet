...
const nextConfig = {
    ...
    async redirects() {
        return [{
            source: '/:locale/terms-of-services/', destination: '/:locale/terms-of-service/', permanent: true,
            ...
            source: '/ai-solutions/:path*', destination: '/en/ai-companions/:path*', permanent: true,
        }, {
            source: '/ai-solutions', destination: '/en/ai-companions', permanent: true,
        }, {
            source: '/ai-companions/:path*', destination: '/en/ai-companions/:path*', permanent: true,
        }, {
            source: '/ai-companions', destination: '/en/ai-companions/', permanent: true,
        }, {
            source: '/:locale/ai-companions/buakaew', destination: '/en/ai-companions/fah', permanent: true,
        }, {
            source: '/:locale/ai-companions/tonnam', destination: '/en/ai-companions/fah', permanent: true,
        }, {
            source: '/:locale/ai-companions/milk', destination: '/en/ai-companions/fah', permanent: true,
        }, {
            ...
            source: '/:locale/contact-chorn', destination: '/:locale/about-chorn', permanent: true,
        }, {
            source: "/contact", destination: "/en/about-chorn", permanent: true
        }, {
            source: '/contact-chorn', destination: "/en/about-chorn", permanent: true,
        }, {
            ...
            source: '/services/:path*', destination: '/en/technical-expertise/:path*', permanent: true,
        }, {
            ...
            source: "/e-commerce-development", destination: "/en/technical-expertise/web-development/", permanent: true
        }, {
            source: "/mvp", destination: "/en/technical-expertise/web-development/", permanent: true
        }, {
            source: "/back-end-development",
            destination: "/en/technical-expertise/full-stack-developer/",
            permanent: true
        }, {
            source: "/technical-expertise/:path*", destination: "/en/technical-expertise/:path*", permanent: true
        }, {
            ...
            source: "/devops-and-testing", destination: "/en/technical-expertise/devops-testing/", permanent: true
        }, {
            source: "/about-us/2", destination: "/en/about-chorn", permanent: true
        }, {
            source: "/single-page-application", destination: "/en/technical-expertise/web-development/", permanent: true
        }, {
            source: "/gallery", destination: "/en/gallery/", permanent: true
        }, {
            source: "/galleries", destination: "/en/gallery/", permanent: true
        }, {
            source: "/gits", destination: "/en/technical-expertise/devops-testing/github/", permanent: true
        }, {
            source: "/microservices-technology",
            destination: "/en/technical-expertise/web-development/",
            permanent: true
        }, {
            source: "/responsive-web-design", destination: "/en/technical-expertise/web-development/", permanent: true
        }, {
            source: "/scaling", destination: "/en/technical-expertise/web-development/", permanent: true
        }, {
            source: "/chorn-services", destination: "/en/technical-expertise/web-development/", permanent: true
        }, {
            source: "/contact-chorn", destination: "/en/about-chorn", permanent: true
        }, {
            source: "/services", destination: "/en/technical-expertise/web-development/", permanent: true
        }, {
            source: "/privacy-policy", destination: "/en/privacy-policy", permanent: true
        }, {
            source: "/src", destination: "/en", permanent: true
        }];
    },
};
